...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { active: @sensor.active, latitude: @sensor.latitude, longitude: @sensor.longitude, type: @sensor.type }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { active: @sensor.active, latitude: @sensor.latitude, longitude: @sensor.longitude, type: @sensor.type }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
